...
ta_doggia = {
    "manos":config['manos_user_id'],
    "koulis":config['koulis_user_id'],
    "modias":config['modias_user_id'],
    "mikras":config['mikras_user_id'],
    "siopis":config['siopis_user_id'],
    "terlis":config['terlis_user_id'],
    "sak":config['sak_user_id'],
    "koke":config['koke_user_id'],
    "cody":config['cody_user_id'],
    "nasos":config['nasos_user_id'],
    "vassano":config['vassano_user_id'],
    "yaku":config['yaku_user_id'],
    "mike":config['mike_user_id'],
    "takas":config['takas_user_id']
}
